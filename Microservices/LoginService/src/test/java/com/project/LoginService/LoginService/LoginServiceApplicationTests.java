...
class LoginServiceApplicationTests {
	...
	void testUpdate() throws Exception {
		CustomerEntity customerEntity = new CustomerEntity(103, "deepthi", "test", 10);
		CustomerPojo customerPojo= new CustomerPojo(103,"deepthi","test",10);
		when(custDao.save(customerEntity)).thenReturn(customerEntity);
		assertEquals(customerEntity, customerServiceImpl.updateRewards(customerEntity));
	}
